...
import FishingLesson from '../services/FishingLessonService';
...
export default {
    ...
    methods: {
        addFishingLesson() {
			this.fishingLesson.userId = JSON.parse(localStorage.getItem('user')).id;
			FishingLesson.addFishingLesson(this.fishingLesson);
        }
    }
}
